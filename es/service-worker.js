...
if (!self.location.pathname.startsWith('/es/')) {
  console.warn('⛔ SW de /es/ ignorado fora do escopo.');
  self.skipWaiting();
}

const CACHE_NAME = 'pintando-a-palavra-es-v1.0.40';
const OFFLINE_URL = '/es/offline.html';
...
const FILES_TO_CACHE = [
  ...
  '/es/login.html',
  '/es/manifest.json',
  '/es/audio/entrada.mp3', // 🔊 Som local (coloque o arquivo na pasta /audio/)
  '/es/img/icon-512.png',
  '/es/img/icon-192.png',
  '/es/app/index.html',
  '/es/atividades/index.html',
  '/es/pdfcompleto/index.html',
  '/es/offline.html'
];
