...
if (!self.location.pathname.startsWith('/en/')) {
...
const FILES_TO_CACHE = [
  ...
  '/en/login.html',
  '/en/manifest.json',
  '/en/audio/entrada.mp3', // 🔊 Som local (coloque o arquivo na pasta /audio/)
  '/en/img/icon-512.png',
  '/en/img/icon-192.png',
  '/en/app/index.html',
  '/en/atividades/index.html',
  '/en/pdfcompleto/index.html',
  '/en/offline.html'
];
