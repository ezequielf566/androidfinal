...
style.textContent =   /* Allow vertical panning on the page; the board itself can still handle its own gestures */   html, body { overscroll-behavior-y: contain; touch-action: pan-y; }   /* Make sure the drawing surface doesn't accidentally disable the entire page scrolling */   .svgMount { -webkit-overflow-scrolling: touch; }   /* Keep mouse-wheel on nested scroll containers smooth */   .scroll-y, .panel, .wrap { -webkit-overflow-scrolling: touch; }  ;
