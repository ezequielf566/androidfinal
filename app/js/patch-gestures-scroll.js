...
(function(){
  ...
  // ------- 🧩 Fix simples: permitir rolar até o limite esquerdo -------
  window.addEventListener("DOMContentLoaded", () => {
    const svgMount = document.getElementById("svgMount");
    if (!svgMount) return;

    // Garante espaço igual dos dois lados para rolar
    svgMount.style.paddingLeft = "80px";
    svgMount.style.paddingRight = "80px";
    svgMount.style.overflowX = "auto";
    svgMount.style.touchAction = "pan-x pan-y";
  });
})();
